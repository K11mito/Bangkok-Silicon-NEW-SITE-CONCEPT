    ...
    <footer className="relative border-t border-white/[0.08] pt-16 md:pt-24 pb-10">
      <div className="max-w-[1400px] mx-auto px-6 md:px-10">
        <div className="relative mb-16 overflow-hidden">
          {/* watermark wordmark — sits behind the link grid */}
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 flex items-center justify-center z-0"
          >
            <div className="serif italic text-[clamp(80px,16vw,220px)] leading-[0.9] tracking-[-0.04em] text-white/[0.05] whitespace-nowrap select-none">
              Bangkok Silicon
            </div>
          </div>

          <div className="relative z-10 grid md:grid-cols-[1.4fr_1fr_1fr_1fr] gap-10 md:gap-14">
            <div>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-[12px] text-white/40 pt-8 border-t border-white/[0.06]">
