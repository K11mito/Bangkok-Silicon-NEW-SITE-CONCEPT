...
interface UniformValue<T = number | Color> { value: T }
...
interface SilkPlaneProps { uniforms: SilkUniforms }
...
const Silk: React.FC<SilkProps> = ({ speed = 3, scale = 1, color = '#1a2342', noiseIntensity = 1.2, rotation = 0 }) => {
